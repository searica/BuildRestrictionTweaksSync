		...
		<tr>
			...
			<td align="left">
				<ul>
					...
					<li>Fixed some typos in the config file settings, may want to delete your old config file and regenerate it.</li>
				</ul>
			</td
		<tr>
		<tr>
			...
			<td align="left">
				<ul>
					...
					<li>Force config file to save after initial generation rather than only saving on exit or modifications to prevent errors when players using mods do not exit the game safely.</li>
				</ul>
			</td
		<tr>
		<tr>
