...
| Github Repository: | <img height="18" src="https://github.githubassets.com/favicons/favicon-dark.svg"></img><a href="https://github.com/searica/BuildRestrictionTweaksSync"> BuildRestrictionTweaksSync</a> |
|-----------|---------------|
...
### Credits
This mod was inspired and is a direct fork of BuildRestrictionTweaks by aedenthorn. Thanks for making the original and releasing it into public domain. Also a huge shoutout and thanks to the developers of Jotunn for all their work making the library.
